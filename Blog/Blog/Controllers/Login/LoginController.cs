...
namespace Blog.Controllers
{
    public class LoginController : Controller
    {
        ...
        public  IActionResult Login(string username,string password)
        {
            ...
            Domain.System.User user = _userServiceSvc.GetSingleUser(username, password, out message);
        ...
        {
            string message = string.Empty;
            Domain.System.User user = _userServiceSvc.RegisterUser(username, password, out message);
            if (!string.IsNullOrEmpty(message))
                return Json(new ReturnResult() { IsSuccess = false, Message = message });
